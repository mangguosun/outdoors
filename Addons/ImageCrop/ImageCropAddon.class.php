<?php
namespace Addons\ImageCrop;
use Common\Controller\Addon;

class ImageCropAddon extends Addon {
    ...
    public function ImageCrop($param){
            $param['width'] = $param['width'] ? : 401;
            $param['height'] = $param['height'] ? : 301;
            $param['ratio'] = $param['ratio'] ? : 1.3333;
             // print_r($param);
    ...
    public function imagetest(){
    	$data = $this->receive($_FILES['upload'],'./upload/');

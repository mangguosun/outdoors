...
jQuery(function($){
	...
	var kefu_div =usercenter_div = message_div =history_div='';
	
	return_top_div = '<a href="#top" class="return_top"><i class="glyphicon glyphicon-open"></i><span>返回顶部</span></a>'
	
	usercenter_div = '<a href="#" class="my_qlinks"><i class="glyphicon glyphicon-cog"></i><span>个人中心</span></a>';
	
	message_div = '<a href="#" class="message_list" ><i class="glyphicon glyphicon-bell"></i><span>站内消息</span><em class="num" style="display:none"></em></a>';
	
	kefu_div = '<a href="#" class="leave_message"><i class="glyphicon glyphicon glyphicon-user"></i><span>在线客服</span></a>';
	
	feedback_div = '<a href="#" class="feedback_message"><i class="glyphicon glyphicon-comment"></i><span>意见反馈</span></a>';
	
	history_div = '<a href="#" class="history_list"><i class="glyphicon glyphicon-eye-open"></i><span>最近浏览</span></a>';
	
	
	quickHTML = '<div class="quick_links_panel"><div id="quick_links" class="quick_links">'+return_top_div+usercenter_div+message_div+history_div+kefu_div+feedback_div+'</div><div class="quick_toggle"><a href="javascript:;" class="toggle" title="展开/收起">×</a></div></div><div id="quick_links_pop" class="quick_links_pop hide"></div>',
	...
	function getValidateCode(){
		...
		var validateCodeUrl = validateCode_url;

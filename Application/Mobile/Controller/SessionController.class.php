...
class SessionController extends MobileController
{
    ...
    private function getTalk($message_id, $talk_id)
    {
        if ($message_id != 0) {
            ...
            if ($talk) {
                redirect(U('Mobile/Message/talk', array('talk_id' => $talk['id'])));
            }
            ...
            D('Message')->sendMessage($message['from_uid'], '聊天名称：' . $talk['title'], '您有新的主题聊天', U('Mobile/Message/talk', array('talk_id' => $talk['id'])), is_login(), 0);

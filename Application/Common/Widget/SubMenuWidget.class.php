...
class SubMenuWidget extends Action
{
                ...
                array(
                    array('tab' => 'user', 'title' => '用户', 'href' => U('blog/index/index'), 'icon' => 'user',
                        'children' => array(
                            ...
                            array('tab' => 'child_2', 'title' => '退出', 'href' => U('blog/article/lists', array('category' => 1)))
                        )
                    ),
                    array('title' => '我的财富:20'),
    ...
    public function index($menu_list, $current, $brand, $id)
    {
        //tpl仅作为例子
        ...
        $this->assign('menu_list', $menu_list);
        $this->assign('brand', $brand);
        $this->display(T('Application://Common@Widget/index'));
    }
}
 ...
 * 用于动态调用分类信息 
 */
class TourismEventWidget extends Action
{
    /* 服务service */
    public function TourismEventService($limit = 5)
    {	
    ...
    /*推荐故事Issue*/
    public function TourismEventIssue($limit = 5)
	{	
	...
	/*相关故事Issue*/
	public function TourismEventRelatedIssue($event_id)
	{
	...
	/*推荐商品shop*/
	public function TourismEventShop($limit = 5)
	{	
	...
	/*活动Event*/
	public function TourismEventRecommendEvent($limit = 3)
    {
    ...
    /*对比sex*/
    public function TourismEventSexCompare($id = '')
    {	
    ...
    /*私人定制TailorEvent*/
    public function  TourismEventTailorEvent()
    {	

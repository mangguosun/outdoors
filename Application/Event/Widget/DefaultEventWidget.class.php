 ...
 * 用于动态调用分类信息
 */
class DefaultEventWidget extends Action
{   
    /*服务Service*/
    public function DefaultEventService($limit = 5)
    {   
    ...
    /**推荐故事Issue**/
    public function DefaultEventRecommendIssue($limit = 5)
    {   
    ...
    /*相关故事Issue*/
    public function DefaultEventRelatedissue($event_id)
    {   
    ...
    /*推荐商品Shop*/
    public function DefaultEventShop($limit = 5)
    {   
    ...
    /*推荐线路Event*/
    public function DefaultEventRecommendEvent($limit = 3)
    {
    ...
    /*比例图Sex*/
    public function DefaultEventSexCompare($id = '')
    {   

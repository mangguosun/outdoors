...
(58, 'SyncLogin', '同步登录', '同步登录', 1, '{"type":null,"meta":"","bind":"0","QqKEY":"","QqSecret":"","SinaKEY":"","SinaSecret":""}', 'xjw129xjt', '0.1', 1406598876, 0),
...
(48, 'VERIFY_OPEN', 4, '验证码配置', 4, '0:全部关闭\r\n1:全部显示\r\n2:注册显示\r\n3:登录显示', '验证码配置', 1388500332, 1405561711, 1, '2', 0),
...
(60, 'AFTER_LOGIN_JUMP_URL', 2, '登录后跳转的Url', 1, '', '支持形如weibo/index/index的ThinkPhp路由写法，支持普通的url写法', 1407145718, 1407154887, 1, 'weibo/index/index', 7),
...
(24, 'syncLogin', '第三方登录位置', 1, 1403700579, 'SyncLogin'),
(25, 'syncMeta', '第三方登录meta接口', 1, 1403700633, 'SyncLogin'),

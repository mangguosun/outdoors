...
if($verify_result) {//验证成功
	...
	if( ! empty($doc->getElementsByTagName( "notify" )->item(0)->nodeValue) ) {
		...
		$data = $userinfo = array();
		$orderinfo = $this->get_userinfo_by_sn($out_trade_no);
		if($orderinfo){
			...
			if($orderinfo['order_type']==1){
			    ...
			    /*2014-10-27
				**denglixing*/
				$webdata['pay_status'] = $event_attend['pay_status'];

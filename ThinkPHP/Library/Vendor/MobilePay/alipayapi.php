...
//服务器异步通知页面路径
$notify_url =  'http://'.$_SERVER['HTTP_HOST'].'/Mobile/Respond/respond_post';
//需http://格式的完整路径，不允许加?id=123这类自定义参数

//页面跳转同步通知页面路径
$call_back_url =  'http://'.$_SERVER['HTTP_HOST'].'/Mobile/Respond/respond_get';
//需http://格式的完整路径，不允许加?id=123这类自定义参数
...
//卖家支付宝帐户
$seller_email = 'pay@huodongli.cn';
//必填

//商户订单号
$out_trade_no = $_SESSION['mobile'][is_login()]['order']['order_id'];
//商户网站订单系统中唯一订单号，必填

//订单名称
$subject = $_SESSION['mobile'][is_login()]['order']['title'];
//必填

//付款金额
$total_fee = $_SESSION['mobile'][is_login()]['order']['payprice'];
//必填

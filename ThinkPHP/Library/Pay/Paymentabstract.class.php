...
abstract class Paymentabstract
{
	...
	{
		if (strtoupper($this->config['gateway_method']) == 'POST') $str = '<form id="paysubmit" name="paysubmit" action="' . $this->config['gateway_url'] . '" method="POST">';
		else $str = '<form id="paysubmit" name="paysubmit" action="' . $this->config['gateway_url'] . '" method="GET">';
	...
	public function get_code_weixin(){
